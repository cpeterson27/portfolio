  ...
  projects: [
    {
      ...
      images: [
        ...
        process.env.PUBLIC_URL + "/images/growthoperator-campaigns.png",
        process.env.PUBLIC_URL + "/images/growthoperator-launch.png",
        process.env.PUBLIC_URL + "/images/growthoperator-contacts.png",
        process.env.PUBLIC_URL + "/images/growthoperator-discovery.png",
        process.env.PUBLIC_URL + "/images/growthoperator-outreach.png",
        process.env.PUBLIC_URL + "/images/growthoperator-conversations.png",
        process.env.PUBLIC_URL + "/images/growthoperator-aicontent.png",
        process.env.PUBLIC_URL + "/images/growthoperator-events.png",
        process.env.PUBLIC_URL + "/images/growthoperator-analytics.png",
        process.env.PUBLIC_URL + "/images/growthoperator-affiliate.png",
        process.env.PUBLIC_URL + "/images/growthoperator-integrations.png",
      ...
      description:
        "A private, full-scale growth operations platform that brings campaign planning, audience discovery, contact management, outreach, conversations, events, affiliate workflows, and performance analytics into one command center. The product includes a guided campaign launch flow, reusable AI-assisted content, workspace-wide search, business-card scanning, third-party integrations, and Jarvis, an embedded AI assistant designed to help teams operate and grow from a single workspace.",
      tags: [
    ...
    },
    {
      ...
      description:
        "An MVP Chrome extension in active development for saving, searching, restoring, and organizing browser sessions so users can recover lost tabs and workflows. Trace supports manual session saves, background auto-save with duplicate prevention, restore-in-new-window flows, search across tabs/URLs/tags/summaries, pinned favorites, category tags, renamed sessions, editable summaries, copied session links, JSON import/export, collapsible tab lists, and a clean popup UI. Planned upgrades include AI-generated summaries, semantic search, cloud sync, user accounts, Stripe subscription billing, and Chrome Web Store release.",
      tags: [
        "React",
        "TypeScript",
        "Vite",
    ...
    },
    {
      ...
      description:
        "A production business website, customer portal, and admin dashboard for an independent auto service shop. The platform supports service content, contact submissions, customer authentication with email verification and password reset, appointment booking/rescheduling/cancellation, invoice and expense workflows, customer records, business settings, Cloudinary image/video gallery management, Resend transactional email, Klaviyo opt-ins, and a Vercel/Render deployment split.",
      tags: [
        "React 18",
        "TypeScript",
        "Vite",
